...
img1 = Image.open('that_girl_2.png')
img1.thumbnail((600, 550))      # 650 --> 550
img2 = Image.open('that_girl.png')
img2.thumbnail((600, 550))
img3 = Image.open('that_girl_2.png')
img3.thumbnail((600, 550))
img4 = Image.open('that_girl.png')
img4.thumbnail((600, 550))
